...
2. **Predict Page** (`/predict`): Input form for transaction details
3. **Submit Page** (`/submit`): Shows prediction result
...
3. **SVM**: Good for complex boundaries
4. **Extra Trees**: Similar to Random Forest, often faster
